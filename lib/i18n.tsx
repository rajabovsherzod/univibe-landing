...
const DICT: Record<string, Record<Lang, string>> = {
  ...
  // ── for students page ──
  "fs.eyebrow": { uz: "Talabalar uchun", en: "For students", ru: "Для студентов" },
  "fs.title1": { uz: "Universitet hayotini yasha va", en: "Live your campus life and", ru: "Живи студенческой жизнью и" },
  "fs.title.accent": { uz: "mukofot ol", en: "get rewarded", ru: "получай награды" },
  "fs.subtitle": { uz: "Tadbirlarni kashf eting, jamoalarga qo'shiling, coin yig'ing va sovg'alar yuting — barchasi bitta ilovada.", en: "Discover events, join communities, earn coins and win rewards — all in one app.", ru: "Открывайте события, вступайте в сообщества, копите баллы и выигрывайте награды — всё в одном приложении." },
  "fs.cta": { uz: "Ilovaga kirish", en: "Open the app", ru: "Открыть приложение" },
  "fs.1.t": { uz: "Tadbir va klublarni kashf eting", en: "Discover events and clubs", ru: "Открывайте события и клубы" },
  "fs.1.d": { uz: "Universitetdagi barcha tadbirlarni ko'ring, ro'yxatdan o'ting va qiziqishingizga mos klublarga qo'shiling.", en: "See every event on campus, register, and join clubs that match your interests.", ru: "Смотрите все события кампуса, регистрируйтесь и вступайте в клубы по интересам." },
  "fs.2.t": { uz: "Ishtirok uchun coin yig'ing", en: "Earn coins for taking part", ru: "Зарабатывайте баллы за участие" },
  "fs.2.d": { uz: "Har bir tadbirda qatnashish, faollik va yutuqlar uchun coin oling.", en: "Get coins for attending events, staying active and achieving goals.", ru: "Получайте баллы за участие, активность и достижения." },
  "fs.3.t": { uz: "Profil va portfolio quring", en: "Build your profile and portfolio", ru: "Создайте профиль и портфолио" },
  "fs.3.d": { uz: "Faolligingiz avtomatik yoziladi — rezyume uchun tayyor portfolio.", en: "Your activity is logged automatically — a ready-made portfolio for your CV.", ru: "Активность фиксируется автоматически — готовое портфолио для резюме." },
  "fs.4.t": { uz: "Mukofotlarni almashtiring", en: "Redeem rewards", ru: "Обменивайте награды" },
  "fs.4.d": { uz: "To'plangan coinlarni brend mahsulot, imtiyoz va maxsus imkoniyatlarga almashtiring.", en: "Exchange your coins for branded merch, perks and special opportunities.", ru: "Обменивайте баллы на мерч, привилегии и особые возможности." },

  // ── for universities page ──
  "fu.eyebrow": { uz: "Universitetlar uchun", en: "For universities", ru: "Для университетов" },
  "fu.title1": { uz: "Butun kampus faolligi —", en: "All campus activity —", ru: "Вся активность кампуса —" },
  "fu.title.accent": { uz: "bitta tizimda", en: "in one system", ru: "в одной системе" },
  "fu.subtitle": { uz: "Taxminlar emas, aniq ma'lumot bilan qaror qabul qiling. Tadbir yarating, davomat oling va ta'sirni o'lchang.", en: "Make decisions with real data, not guesses. Create events, take attendance and measure impact.", ru: "Принимайте решения на данных, а не догадках. Создавайте события, отмечайте посещаемость и измеряйте результат." },
  "fu.cta": { uz: "Demo so'rash", en: "Request a demo", ru: "Запросить демо" },
  "fu.1.t": { uz: "Real vaqt tahlili", en: "Real-time analytics", ru: "Аналитика в реальном времени" },
  "fu.1.d": { uz: "Fakultet, kafedra va klub bo'yicha qatnashuvni jonli kuzating.", en: "Track participation by faculty, department and club — live.", ru: "Отслеживайте участие по факультетам, кафедрам и клубам вживую." },
  "fu.2.t": { uz: "QR-davomat", en: "QR attendance", ru: "QR-посещаемость" },
  "fu.2.d": { uz: "Tadbirlarda davomat QR orqali avtomatik, aniq va soxtalashtirib bo'lmaydigan.", en: "Event attendance via QR — automatic, accurate and tamper-proof.", ru: "Посещаемость на событиях через QR — автоматически, точно и без подделок." },
  "fu.3.t": { uz: "Eksport hisobotlar", en: "Exportable reports", ru: "Экспорт отчётов" },
  "fu.3.d": { uz: "Rahbariyat va akkreditatsiya uchun tayyor, eksport qilinadigan hisobotlar.", en: "Ready, exportable reports for leadership and accreditation.", ru: "Готовые экспортируемые отчёты для руководства и аккредитации." },
  "fu.4.t": { uz: "Yagona tizim", en: "One unified system", ru: "Единая система" },
  "fu.4.d": { uz: "Tadbirlar, ballar, klublar va tahlil — hammasi bitta boshqaruv panelida.", en: "Events, coins, clubs and analytics — all in one dashboard.", ru: "События, баллы, клубы и аналитика — всё в одной панели." },

  // ── contact page ──
  "ct.eyebrow": { uz: "Aloqa", en: "Contact", ru: "Контакты" },
  "ct.title": { uz: "Bog'lanamiz", en: "Let's talk", ru: "Свяжитесь с нами" },
  "ct.subtitle": { uz: "Univibe demosini ko'rmoqchimisiz yoki savolingiz bormi? Formani to'ldiring — tez orada javob beramiz.", en: "Want to see a Univibe demo or have a question? Fill in the form — we'll reply soon.", ru: "Хотите увидеть демо Univibe или есть вопрос? Заполните форму — мы скоро ответим." },
  "ct.email": { uz: "Email", en: "Email", ru: "Эл. почта" },
  "ct.phone": { uz: "Telefon", en: "Phone", ru: "Телефон" },
  "ct.address": { uz: "Manzil", en: "Address", ru: "Адрес" },
  "ct.address.v": { uz: "Toshkent, O'zbekiston", en: "Tashkent, Uzbekistan", ru: "Ташкент, Узбекистан" },
  "ct.response": { uz: "Javob vaqti", en: "Response time", ru: "Время ответа" },
  "ct.response.v": { uz: "Ish kunlari 24–48 soat ichida javob beramiz.", en: "We reply within 24–48 hours on business days.", ru: "Отвечаем в течение 24–48 часов в рабочие дни." },
  "ct.f.name": { uz: "Ism", en: "Name", ru: "Имя" },
  "ct.f.namePh": { uz: "Ismingiz", en: "Your name", ru: "Ваше имя" },
  "ct.f.org": { uz: "Universitet / Tashkilot", en: "University / Organization", ru: "Университет / организация" },
  "ct.f.orgPh": { uz: "Tashkilotingiz nomi", en: "Your organization", ru: "Название организации" },
  "ct.f.role": { uz: "Rolingiz", en: "Your role", ru: "Ваша роль" },
  "ct.f.rolePh": { uz: "Rolingizni tanlang", en: "Select your role", ru: "Выберите роль" },
  "ct.f.msg": { uz: "Xabar", en: "Message", ru: "Сообщение" },
  "ct.f.msgDefault": { uz: "Men Univibe demosini ko'rmoqchiman", en: "I'd like to see a Univibe demo", ru: "Я хочу посмотреть демо Univibe" },
  "ct.f.submit": { uz: "Yuborish", en: "Send", ru: "Отправить" },
  "ct.role.1": { uz: "Universitet administratori", en: "University administrator", ru: "Администратор университета" },
  "ct.role.2": { uz: "Xodim / O'qituvchi", en: "Staff / Teacher", ru: "Сотрудник / преподаватель" },
  "ct.role.3": { uz: "Talaba", en: "Student", ru: "Студент" },
  "ct.role.4": { uz: "Klub rahbari", en: "Club leader", ru: "Руководитель клуба" },
  "ct.role.5": { uz: "Hamkor", en: "Partner", ru: "Партнёр" },
  "ct.success.title": { uz: "Rahmat!", en: "Thank you!", ru: "Спасибо!" },
  "ct.success.desc": { uz: "Xabaringiz yuborildi. 24–48 soat ichida bog'lanamiz.", en: "Your message was sent. We'll be in touch within 24–48 hours.", ru: "Сообщение отправлено. Мы свяжемся в течение 24–48 часов." },
};
